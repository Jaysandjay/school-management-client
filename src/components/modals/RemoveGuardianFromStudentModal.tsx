...
export default function RemoveGuardianFromStudentModal({
  guardianRelation,
  isOpen,
  onClose,
}: RemoveGuardianFromStudentModalProps) {
  ...
  const mutation = useMutation({
    mutationFn: ({ studentId, guardianId }: RemoveGuardianVariables) =>
      removeStudentGuardian(studentId, guardianId),
    onSuccess: () => {
