...
export default function AssignedGuardiansToStudentCard({studentId}: AssignedGuardiansToStudentCardProps){
            ...
            <BasicContainer title="Guardians" width="w-full" >
                ...
                {isViewingAssignableGuardians ? (
                    ...
                    <div className="mt-5 w-full flex justify-end">
                        {isViewingAssignableGuardians ? (
                            <PrimaryButton title="Cancel" color="bg-red-600" onclick={() => setIsViewingAssignableGuardians(!isViewingAssignableGuardians)}/>
                        ):(
